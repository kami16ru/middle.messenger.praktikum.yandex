export default [{
  ...
  check: (value) => /(?<!\S)(?=\S{8,40}(?!\S))\S*(\d\S*[A-ZА-ЯЁ]|[A-ZА-ЯЁ]\S*\d)\S*/.test(value)
}, {
  name: 'isPhone',
  ...
  check: (value) => /^[a-zA-Z][a-zA-Z0-9_-]{2,19}$/.test(value)
}, {
  name: 'isName',
  ...
  check: (value) => /^[A-ZА-ЯЁ][a-zA-Zа-яА-ЯёЁ-]+$/.test(value)
}]
